...
func (client *APIClient) LimitBuy(amount, price string, currency CurrencyPair, opt ...LimitOrderOptionalParameter) (*Order, error) {
	panic("not implement")
}
func (client *APIClient) LimitSell(amount, price string, currency CurrencyPair, opt ...LimitOrderOptionalParameter) (*Order, error) {
	panic("not implement")
}
func (client *APIClient) MarketBuy(amount, price string, currency CurrencyPair) (*Order, error) {
	panic("not implement")
}
func (client *APIClient) MarketSell(amount, price string, currency CurrencyPair) (*Order, error) {
	panic("not implement")
}
func (client *APIClient) CancelOrder(orderId string, currency CurrencyPair) (bool, error) {
	panic("not implement")
}
func (client *APIClient) GetOneOrder(orderId string, currency CurrencyPair) (*Order, error) {
	panic("not implement")
}
func (client *APIClient) GetUnfinishOrders(currency CurrencyPair) ([]Order, error) {
	panic("not implement")
}
func (client *APIClient) GetOrderHistorys(currency CurrencyPair, optional ...OptionalParameter) ([]Order, error) {
	panic("not implement")
}
func (client *APIClient) GetAccount() (*Account, error) {
	panic("not implement")
}
func (client *APIClient) GetKlineRecords(currency CurrencyPair, period KlinePeriod, size int, opt ...OptionalParameter) ([]Kline, error) {
	panic("not implement")
}

func (client *APIClient) GetTrades(currencyPair CurrencyPair, since int64) ([]Trade, error) {
	panic("not implement")
}
func (client *APIClient) GetTicker(currency CurrencyPair) (*Ticker, error) {
	panic("not implement")
}

func (client *APIClient) GetDepth(size int, currency CurrencyPair) (*Depth, error) {
	panic("not implement")
}
...
func NewAPI(client *http.Client, accessKey string, secretKey string) *APIClient {
	return &APIClient{accessKey, secretKey, client}
}

func (client *APIClient) GetExchangeName() string {
	return BUDA
}
/*
func (client *APIClient) GetDepth(size int, currency CurrencyPair) (*Depth, error) {
